...
INSERT INTO `preguntas` (`idPregunta`,`descripcion`,`opcion1`,`opcion2`,`opcion3`,`opcion_true`) VALUES
	(1,'Who am I? PiPaPoPU!','George Lucas','Amy Acker','Artoo (R2D2)','Stephen Hawking'),
	(2,'¿Quien es root?','Juanmi','Groot','Snowden','Amy Acker'),
	(3,'¿Quien gana?','Thor','Cpt. America','Ojo de halcón','Iron Man'),
	(4,'"Recuerdo los buenos tiempos, recuerdo buenas historias. Y aún arde _____ en mi memoria."','Londres','Valencia','Mordor','Madrid'),
	(5,'¿Cual es la respuesta al sentido de la vida el universo y todo lo demas?','13','Amy Acker','Taylor Swift','42');
